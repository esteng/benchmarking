...
globalphonesyllabic = ['ab', 'e', 'i', 'i2', 'o', 'oe', 'u', 'ue']
...
globalphone_speechrate_syllables = speech_rate_syllables(globalphonebenchmark, 'utterance', 'syllable', 'speech_rate_syllables')
