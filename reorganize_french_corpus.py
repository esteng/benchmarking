...
original_path = '/media/share/datasets/aligner_benchmarks/AlignerTestData/2_French_2000files'
new_path = '/media/share/datasets/aligner_benchmarks/sorted_quebec_french'
